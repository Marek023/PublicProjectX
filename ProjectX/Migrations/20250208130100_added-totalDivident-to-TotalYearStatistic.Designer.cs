...
namespace ProjectX.Migrations
{
    ...
    [Migration("20250208130100_added-totalDivident-to-TotalYearStatistic")]
    partial class addedtotalDividenttoTotalYearStatistic
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectX.Data.Entities.MonthStatistic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("YearStatisticId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("YearStatisticId");

                    b.ToTable("MonthStatistic");
                });
            ...
            modelBuilder.Entity("ProjectX.Data.Entities.TotalYearStatistic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("ProfitInPercentForYear")
                        .HasColumnType("numeric");

                    b.Property<int>("TotalDeposit")
                        .HasColumnType("integer");

                    b.Property<decimal>("TotalDivident")
                        .HasColumnType("numeric");

                    b.Property<decimal>("TotalProfitForYear")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("ProjectX.Data.Entities.YearStatistic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TotalYearStatisticId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TotalYearStatisticId");

                    b.HasIndex("UserId");

                    b.ToTable("YearStatistic");
                });
            ...
            modelBuilder.Entity("ProjectX.Data.Entities.MonthStatistic", b =>
                {
                    b.HasOne("ProjectX.Data.Entities.YearStatistic", "YearStatistic")
                        .WithMany("MonthStatistics")
                        .HasForeignKey("YearStatisticId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("YearStatistic");
                });
            ...
            modelBuilder.Entity("ProjectX.Data.Entities.YearStatistic", b =>
                {
                    b.HasOne("ProjectX.Data.Entities.TotalYearStatistic", "TotalYearStatistic")
                        .WithMany("YearStatistics")
                        .HasForeignKey("TotalYearStatisticId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("TotalYearStatistic");
